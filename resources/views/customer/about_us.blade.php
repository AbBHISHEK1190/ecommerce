...
<section id="content">
			<div id="page-header">
			<h1>About Us <span class="small-bottom-border big">
			</span>
			</h1>
			<div class="md-margin">
			</div>
...
<!--			<div class="row">
			...
			<div class="service-icon service-icon-responsive">
			</div>
			<h3>
			<a href="#">Responcive Design</a> 
			<span class="small-bottom-border">
			</span>
			</h3>
			...
			<div class="col-md-3 col-sm-3 col-xs-6 service-box-container"><div class="services-box">
			<div class="service-icon service-icon-panel">
			</div>
			<h3>
			...
			<div class="col-md-3 col-sm-3 col-xs-6 service-box-container">
			<div class="services-box">
			<div class="service-icon service-icon-sliders">
			</div>
			<h3>
			...
			<div class="col-md-3 col-sm-3 col-xs-6 service-box-container">
			<div class="services-box">
			<div class="service-icon service-icon-support">
			</div>
			<h3>
			...
			<p>Pellentesque ut libero in nibh aliquet pretium eget elementum felis. Integer dapibus auctor tincidunt. Suspendisse potenti.</p>
                            ...
                            <div class="row">
								...
								<h4>Wordpress</h4>
								<div class="progress">
								<div class="progress-bar progress-bar-custom progress-animate" role="progressbar" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100" data-width="85"><span class="progress-text">85%</span>
								</div>
								</div>
								</div>
								<div class="progress-container">
...
<!--								<div id="testimonials-section">
								...
								<div class="row">
								<div class="col-md-8 col-md-offset-2">
								<h3>Testimonials <span class="small-bottom-border big">
								</span>
								</h3>
								<div class="about-us-testimonials flexslider">
								<ul class="slides"><li><span class="testimonial-title">Best Service!</span>
								...
								<span class="testimonial-owner">Anna Retallick,</span>
								<span class="testimonial-date">12.02.2014</span>
								</li>
								<li>
								...
								<span class="testimonial-owner">Jake Retallick,</span>
								<span class="testimonial-date">21.02.2014</span>
								</li>
								<li>
								<span class="testimonial-title">Quality Design!</span>
								<p>Maecenas semper aliquam massa. Praesent pharetra sem vitae nisi eleifend molestie. Aliquam molestie scelerisque ultricies. Suspendisse potenti. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus tempor dictum ornare. Maecenas pellentesque nibh ac suscipit sodales. Integer quis mattis nibh. Maecenas et eleifend mauris.</p>
								<span class="testimonial-owner">Jake Retallick,</span>
								<span class="testimonial-date">26.02.2014</span>
								</li>
								</ul>
								</div>
								</div>
								...
								<figure><img src="images/team/bryant.jpg" alt="Dawe Bryant" class="img-responsive">
								</figure>
								<div class="md-margin visible-xs visible-sm">
								</div>
								</div>
								...
								<p>Suspendisse potenti. In non tincidunt mauris. Sed accumsan augue a gravida posuere. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus tempor dictum ornare. Maecenas pellentesque nibh ac suscipit sodales. Integer quis mattis nibh. Aliquam arcu velit, blandit sit amet neque vitae, eleifend feugiat lorem. Suspendisse potenti.</p><blockquote><p>Maecenas semper aliquam massa. Praesent pharetra sem vitae nisi eleifend molestie. Aliquam molestie scelerisque ultricies. Suspendisse potenti. Phasellus interdum risus at mi ullamcorper lobortis. In et metus aliquet, suscipit leo.</p>
								</blockquote>
								...
								<li class="smaller-social-icons">
								<a href="#" class="social-icon icon-facebook-sm">
								</a>
								</li>
								<li class="smaller-social-icons">
								<a href="#" class="social-icon icon-twitter-sm">
								</a>
								</li>
								<li class="smaller-social-icons">
								<a href="#" class="social-icon icon-dribbble-sm">
								</a>
								</li>
								<li class="smaller-social-icons">
								<a href="#" class="social-icon icon-email-sm">
								</a>
								</li>
								</ul>
