...
<img src="{{asset("assets/images/products/categories/$categories->cat_image")}}" alt="Phone" class="img-responsive">
</div>
</div>
...
<p>
    {{$categories->category_description}}.</p>
...
<div class="view-box">
<a href="category.html" class="active icon-button icon-grid">
<i class="fa fa-th-large">
</i>
</a> 
<a href="category-list.html" class="icon-button icon-list">
...
<input id="urldata" type="hidden" value="{{Request::segment(2)}}">
</div>
<div class="md-margin">
</div>
<div class="category-item-container">
<div class="row">
    <div class="resultcategoriesmenucategoriesdata">
...
<a href="https://localhost/devansh/product/NDI=">
<img src="https://localhost/devansh/assets/images/products/item1.jpg" alt="item1" class="item-image">

 <img src="https://localhost/devansh/assets/images/products/item2.jpg" alt="item1  Hover" class="item-image-hover">
 </a>
 </figure>
 <div class="item-price-container">
 <span class="old-price">₹100<span class="sub-price"></span></span>
 <span class="item-price">₹90<span class="sub-price"></span></span>
 </div>
            ...
            <div class="panel-group custom-accordion sm-accordion" id="category-filter">
                <div class="panel">
                    <div class="accordion-header">
                        ...
                        <a class="accordion-btn opened" data-toggle="collapse" data-target="#category-list-1">
                ...
                <div class="panel">
                    <div class="accordion-header">
                        ...
                        <a class="accordion-btn opened" data-toggle="collapse" data-target="#category-list-2">
                ...
                <div class="panel">
                    <div class="accordion-header">
                        <div class="accordion-title"><span>Price</span>
                        </div>
                        <a class="accordion-btn opened" data-toggle="collapse" data-target="#category-list-3">
                ...
                <div class="panel">
                    <div class="accordion-header">
                        ...
                        <a class="accordion-btn opened" data-toggle="collapse" data-target="#category-list-4">
                    ...
                    <div id="category-list-4" class="collapse in">
                        <div class="panel-body">
                            <ul class="filter-color-list clearfix">
                                ...
                                <li>
                                    <a href="#" data-bgcolor="#999999" class="filter-color-box">
                ...
                <ul class="featured-list clearfix">
                    <li>
                        <div class="featured-product clearfix">
                            <figure>
                                <img src="images/products/thumbnails/item5.jpg" alt="item5"></figure>
                            <h5>
                        ...
                        <div class="featured-product clearfix">
                            <figure>
                                <img src="images/products/thumbnails/item1.jpg" alt="item1"></figure><h5>
                        ...
                        <div class="featured-product clearfix">
                            ...
                            <h5>
                                <a href="#">Women's Lauren Dress</a></h5>
                            <div class="ratings-container">
                                <div class="ratings">
                                    <div class="ratings-result" data-result="84">
                    ...
                    <li>
                        <div class="featured-product clearfix">
                            ...
                            <h5>
                                <a href="#">Swiss Mobile Phone</a></h5>
                            <div class="ratings-container">
                                <div class="ratings">
                        ...
                        <div class="featured-product clearfix">
                            <figure>
                                <img src="images/products/thumbnails/item4.jpg" alt="item4"></figure>
                            <h5>
