...
@endforeach
    <a data-rel="prettyPhoto[product]" href="{{asset("assets/images/products/$data->image1")}}" data-image="{{asset("assets/images/products/$data->image1")}}" data-zoom-image="{{asset("assets/images/products/$data->image1")}}" class="product-gallery-item">
<img src="{{asset("assets/images/products/$data->image1")}}" alt="Phone photo 1">
</a>
</li>
<li>
<a data-rel="prettyPhoto[product]" href="{{asset("assets/images/products/$data->image2")}}" data-image="{{asset("assets/images/products/$data->image2")}}" data-zoom-image="{{asset("assets/images/products/$data->image2")}}" class="product-gallery-item">
<img src="{{asset("assets/images/products/$data->image2")}}" alt="Phone photo 2">
</a>
</li>
<li>
<a data-rel="prettyPhoto[product]" href="{{asset("assets/images/products/$data->image3")}}" data-image="{{asset("assets/images/products/$data->image3")}}" data-zoom-image="{{asset("assets/images/products/$data->image3")}}" class="product-gallery-item">
<img src="{{asset("assets/images/products/$data->image3")}}" alt="Phone photo 3">
</a>
</li>
<li>
<a data-rel="prettyPhoto[product]" href="{{asset("assets/images/products/$data->image4")}}" data-image="{{asset("assets/images/products/$data->image4")}}" data-zoom-image="{{asset("assets/images/products/$data->image4")}}" class="product-gallery-item">
<img src="{{asset("assets/images/products/$data->image4")}}" alt="Phone photo 4">
</a>
</li>
<li>
<a data-rel="prettyPhoto[product]" href="{{asset("assets/images/products/$data->image5")}}" data-image="{{asset("assets/images/products/$data->image5")}}" data-zoom-image="{{asset("assets/images/products/$data->image5")}}" class="product-gallery-item">
<img src="{{asset("assets/images/products/$data->image5")}}" alt="Phone photo 5">
</a>
</li>
</ul>
</div>
...
<figure>
    ...
    <img class="xzoom" src="{{asset("assets/images/products/$data->image1")}}" data-zoom-image="{{asset("assets/images/products/$data->image1")}}"  alt="Product Big image" id="product-image">
<figcaption class="item-price-container">
<span class="old-price">₹ {{(int) $alldata['0']->mrp}}</span> 
<span class="item-price">₹ {{(int) $alldata['0']->mrp-($alldata['0']->mrp*$alldata['0']->discount_available/100)}}</span>
</figcaption>
</figure>
</div>
</div>
...
<h1 class="product-name">{{$alldata['0']->product_name}}</h1>
<!--<div class="ratings-container">
<div class="ratings separator">
<div class="ratings-result" data-result="70">
</div>
</div>
...
<!-- <li>
 <span>Product Code:</span>483512569</li>
 <li>-->
...
<!-- <div class="product-color-filter-container">
 ...
 <li>
 <a href="#" data-bgcolor="#d1d2d4" class="filter-color-box">
 </a>
 </li>
 <li>
 <a href="#" data-bgcolor="#666467" class="filter-color-box">
 </a>
 </li>
 <li>
 <a href="#" data-bgcolor="#515151" class="filter-color-box">
 </a>
 </li>
 <li>
 <a href="#" data-bgcolor="#bcdae6" class="filter-color-box">
 </a>
 </li>
 <li>
 <a href="#" data-bgcolor="#5272b3" class="filter-color-box">
 </a>
 </li>
 <li>
 <a href="#" data-bgcolor="#acbf0b" class="filter-color-box">
 </a>
 </li>
 </ul>
 </div>-->
...
<!-- <div class="custom-quantity-input">
 ...
 <button onclick="addcart('NDQ=');" class="btn btn-custom-2">ADD TO CART</button>
 </div><div class="md-margin">
 </div>
...
<!-- <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-52b2197865ea0183"></script>-->
 ...
 <ul class="nav-tabs"><li class="active">
...
<!-- <li>
 ...
 <ul class="product-details-list"><li>3rd gen Intel® Core™ i7 quad core processor available;</li>
...
<!-- <div class="tab-pane" id="video">
 ...
 <div class="lg-margin2x visible-sm visible-xs">
 </div>
<!-- <div class="col-md-3 col-sm-12 col-xs-12 sidebar">
 <div class="widget related"><h3>Related</h3><div class="related-slider flexslider sidebarslider"><ul class="related-list clearfix"><li>
 <div class="related-product clearfix">
 <figure><img src="images/products/thumbnails/item1.jpg" alt="item1"></figure>
 <h5><a href="#">Jacket Suiting Blazer</a></h5>
 <div class="ratings-container"><div class="ratings">
 <div class="ratings-result" data-result="84">
 </div></div></div><div class="related-price">$40</div>
 </div>
 <div class="related-product clearfix">
 <figure><img src="images/products/thumbnails/item2.jpg" alt="item2">
 </figure><h5><a href="#">Gap Graphic Cuffed</a>
 </h5>
 <div class="ratings-container">
 <div class="ratings">
 <div class="ratings-result" data-result="84">
 ...
 <div class="related-product clearfix">
 <figure>
 <img src="images/products/thumbnails/item4.jpg" alt="item4"></figure><h5><a href="#">Swiss Mobile Phone</a>
 </h5>
 <div class="ratings-container">
 <div class="ratings">
 <div class="ratings-result" data-result="64">
 </div>
 </div>
 </div>
 ...
 <div class="related-product clearfix">
 <figure>
 <img src="images/products/thumbnails/item5.jpg" alt="item5"></figure><h5>
 <a href="#">Zwinzed HeadPhones</a>
 </h5>
 <div class="ratings-container">
 <div class="ratings">
 <div class="ratings-result" data-result="94">
 </div>
 </div>
 </div>
 ...
 <div class="ratings-container">
 <div class="ratings">
 <div class="ratings-result" data-result="74">
 </div>
 </div>
 </div>
 ...
 <h5>
 <a href="#">Women's Lauren Dress</a>
 </h5><div class="ratings-container">
 <div class="ratings">
 <div class="ratings-result" data-result="84">
 </div>
 </div>
     ...
     @foreach($similars as $sim)
      <div class="item item-hover">
			...
			<figure class="item-image-container">
                      <a href="{{url('product_description',[base64_encode($sim->product_id)])}}">
			<img src="{{asset("assets/images/products/$sim->image1")}}" alt="item1" class="item-image"> 
			<img src="{{asset("assets/images/products/$sim->image2")}}" alt="item1  Hover" class="item-image-hover">
			</a>
			</figure>
			<div class="item-price-container">
			<span class="item-price">₹
{{$sim->mrp-($sim->mrp*$sim->discount_available/100)}}</span>
			</div>
			...
			<h3 class="item-name">
			<a>{{$sim->product_name}}</a>
			</h3>
			<div class="item-action">
                      <a onclick="addcart('NDI=');" class="item-add-btn">
